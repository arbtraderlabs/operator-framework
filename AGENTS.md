...
model, or a multi-model pipeline. See [`docs/model-routing.md`](docs/model-routing.md)
...
the framework defines — especially [`skills/verify.md`](skills/verify.md)
and [`skills/public-release.md`](skills/public-release.md), which require
...
6. **Synthetic data only.** Never introduce real customer data, production
   ...
   [`skills/public-release.md`](skills/public-release.md)).
...
9. **Leave a clean handoff.** If your turn ends mid-task, update state per
   [`skills/handoff.md`](skills/handoff.md) so the next agent (human or
...
- Nothing marked "public" contains anything that wouldn't survive the
  [`skills/public-release.md`](skills/public-release.md) scan.
