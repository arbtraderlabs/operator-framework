...
which model must produce it. See [`docs/model-routing.md`](docs/model-routing.md)
for how to choose a model for a given task without coupling the methodology
to that choice.

## 3. Small, reviewable units of work

Work is decomposed into tickets (see [`docs/ticket-system.md`](docs/ticket-system.md))
...
first (see [`skills/resolve.md`](skills/resolve.md) and
...
project's decision ledger (see [`docs/decision-ledger.md`](docs/decision-ledger.md)
and [`templates/decision-ledger-entry.md`](templates/decision-ledger-entry.md)).
...
through [`skills/verify.md`](skills/verify.md). Verification is independent
...
[`skills/public-release.md`](skills/public-release.md) before anything is
published.
...
[`skills/public-release.md`](skills/public-release.md) defines the explicit
