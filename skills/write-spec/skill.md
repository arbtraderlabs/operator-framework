...
2. **Write numbered, testable requirements.** Each one should be checkable
   later during [`skills/verify/skill.md`](../verify/skill.md) — avoid requirements that
   can't be confirmed objectively.
3. **Describe the design** at the level of detail
   [`skills/plan-tickets/skill.md`](../plan-tickets/skill.md) needs to decompose it —
...
[`skills/plan-tickets/skill.md`](../plan-tickets/skill.md)
